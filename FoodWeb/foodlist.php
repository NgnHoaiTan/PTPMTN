...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="cart.php"><i class="fas fa-shopping-cart" style="margin-right: 10px;"></i>Cart  (<?php
              ...
              echo "$count"; 
                ...
                echo "0";
              ?>) </a></li>
            <li><a href="logout_u.php"><i class="fas fa-sign-out-alt"style="margin-right: 10px;"></i>Log Out </a></li>
          </ul>
  <?php        
}
else {
